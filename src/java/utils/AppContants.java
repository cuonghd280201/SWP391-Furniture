...
//        public static final String LOGIN_PAGE = "loginPage";
    ...
    public class CreateInquiryFeature {

        public static final String ERROR_PAGE = "errorPage";
        public static final String MY_INQUIRY_PAGE = "homePage";
        public static final String SUBMIT_INQUIRY_PAGE = "DisplayInquiryCustomer";
    }
    ...
    public class DisplayDetailProject {
        ...
        public static final String MY_DETAIL_PROJECT_PAGE = "myDetailProjectPage";
    }

    public class DisplayDetailInquiry {
