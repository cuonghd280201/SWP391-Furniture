...
public class InteriorDetailsDTO {
    ...
    public InteriorDetailsDTO(int interiorID, String interiorName, int size, int unit, double mass, double unitPrice, double money, String description, String image, int projectID, Timestamp createAt, Timestamp updateAt, int status, int marterialD, String materialName, double price) {
