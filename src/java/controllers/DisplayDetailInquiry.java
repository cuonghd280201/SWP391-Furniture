 ...
 * @author Admin
 */
@WebServlet(name = "DisplayDetailInquiry", urlPatterns = {"/DisplayDetailInquiry"})
public class DisplayDetailInquiry extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // End get site map
        // Mapping url
        String url = siteMaps.getProperty(AppContants.DisplayDetailInquiry.MY_DETAIL_INQUIRY_PAGE);
        try {
            ...
            request.setAttribute("DETAIL_INQUIRY", inquiryDTO);
