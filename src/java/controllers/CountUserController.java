 ...
 * @author Admin
 */
@WebServlet(name = "CountUserController", urlPatterns = {"/CountUserController"})
public class CountUserController extends HttpServlet {

    private final String HOME_PAGE_USER = "/views/admin/dashboard.jsp";
