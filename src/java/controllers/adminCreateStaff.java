 ...
 * @author Admin
 */
@WebServlet(name = "adminCreateStaff", urlPatterns = {"/adminCreateStaff"})
public class adminCreateStaff extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(adminCreateStaff.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
