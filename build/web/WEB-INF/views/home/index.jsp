                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto">
                            <a href="<c:url value="/home/index.vn"/>" class="nav-item nav-link active">Home</a>
                            <a href="<c:url value="/admin/dashboard.vn"/>" class="nav-item nav-link">About</a>
                        ...
                        <div class="header__user">
                            <c:if test="${sessionScope.acc != null}">
                                <a href="#">Hello ${sessionScope.acc.firstName}</a>
                                <a  href="<c:url value="/user/login.vn"/>" class="btn btn-primary px-3 d-none d-lg-flex">Logout</a>
                            </c:if>
                            <c:if test="${sessionScope.acc == null}">
