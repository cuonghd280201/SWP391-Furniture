<%-- 
    Document   : managePriceRange
    Created on : Mar 5, 2024, 1:02:27 AM
    Author     : Admin
--%>
                ...
                <div class="dashboard-ecommerce">
                    <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-header">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Manager PriceRange Info</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <h5 class="card-header">Manage PriceRange</h5>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0">PriceRange ID</th>
                                                        <th class="border-0">PriceRange Name</th>
                                                        <th class="border-0">PriceRange Description</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <c:forEach var="c" items="${requestScope.priceList}">
                                                        <tr>
                                                            <td>${c.priceRangeID}</td>
                                                            <td>${c.priceRangeName}</td>
                                                            <td>${c.priceDescription}</td>   
                                                            <td>
                                                                <button class="update-btn" onclick="openPopup()"><i class="fas fa-edit"></i></button>
                                                                <button class="delete-btn" onclick="openDeletePopup()"><i class="fas fa-trash-alt"></i></button>
                                                            </td>
                        ...
                        <div id="updatePopup" class="popup">
                            <div class="popup-content">
                                <!-- Content of your popup goes here -->
                                <h2>Update PriceRange</h2>
                                <div class="container">
                                    <form action="action_page.php">
                                        <div class="row">
                                            <div class="col-25">
                                                <label for="fname">PriceRange Name</label>
                                            </div>
                                            <div class="col-75">
                                        ...
                                        <div class="row">
                                            <div class="col-25">
                                                <label for="fname">PriceRange Description</label>
                                            </div>
                                            <div class="col-75">
