<%-- 
    Document   : manageScale
    Created on : Mar 5, 2024, 1:02:12 AM
    Author     : Admin
--%>
                                ...
                                <div class="page-header">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Manager Scale Info</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <h5 class="card-header">Manage Scale</h5>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0">Scale ID</th>
                                                        <th class="border-0">Scale Name</th>
                                                        <th class="border-0">Scale Description</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <c:forEach var="c" items="${requestScope.scaleList}">
                                                        <tr>
                                                            <td>${c.scaleID}</td>
                                                            <td>${c.scaleName}</td>
                                                            <td>${c.scaleDescription}</td>   
                                                            <td>
                            ...
                            <div class="popup-content">
                                ...
                                <div class="container">
                                    <form action="action_page.php">
                                        <div class="row">
                                            <div class="col-25">
                                                <label for="fname">Scale Name</label>
                                            </div>
                                            <div class="col-75">
                                        ...
                                        <div class="row">
                                            <div class="col-25">
                                                <label for="fname">Scale Description</label>
                                            </div>
                                            <div class="col-75">
