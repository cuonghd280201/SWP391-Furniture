                                ...
                                <div class="page-header">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Manager ProjectType Info</a></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <h5 class="card-header">Manage ProjectType</h5>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0">ProjectType ID</th>
                                                        <th class="border-0">ProjectType Name</th>
                                                        <th class="border-0">ProjectType Description</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <c:forEach var="c" items="${requestScope.projectTypeList}">
                                                        <tr>
                                                            <td>${c.projectTypeID}</td>
                                                            <td>${c.projectTypeName}</td>
                                                            <td>${c.status}</td>   
                                                            <td>
