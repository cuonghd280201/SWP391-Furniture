                            ...
                            <ul class="navbar-nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" id="managerLink" data-toggle="collapse" data-target="#submenu" aria-expanded="false" aria-controls="submenu">
                                        <i class="fas fa-fw fa-cogs"></i> Home 
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" id="managerLink" data-toggle="collapse" data-target="#submenu" aria-expanded="false" aria-controls="submenu">
                                        <i class="fas fa-fw fa-user"></i> Manager User
                                    </a>
                                    <ul id="submenu" class="collapse">
                                        <li><a href="managerCustomer.jsp">Manage Customer</a></li>
                                        <li><a href="managerStaff.jsp">Manager Staff</a></li>
                                        <!-- ... Other submenu items ... -->
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" id="managerLink" data-toggle="collapse" data-target="#submenu" aria-expanded="false" aria-controls="submenu">
                                        <i class="fas fa-fw fa-info-circle"></i> Manager Information
                                    </a>
                                    <ul id="submenu" class="collapse">
                                        <li><a href="manageConstruction.jsp">Manage Construction</a></li>
                                        <li><a href="manageScale.jsp">Manager Scale</a></li>
                                        <li><a href="managePriceRange.jsp">Manager Price Range</a></li>
                                        <li><a href="manageProjectType.jsp">Manager Project Type</a></li>
